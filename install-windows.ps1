...
echo "Script finished. Make sure to read the output. To display icons, configure your terminal to use a nerd font. After LazyVim finishes installing, it is recommended to run :LazyHealth after installation."
